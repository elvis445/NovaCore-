def smart_reply(user):
    ...
    if "who are you" in user:
        return "My name is NovaCore, your personal AI assistant."

    if "who created you" in user:
        return "I was created by Elvis Sedem Brown."

    if "what can you do" in user:
        return "I can chat, answer questions, speak, and I am improving every day."
    ...
    if (
        "founder of novacore ai biography" in user
        or "who is elvis sedem brown" in user
        or "what is your founder biography" in user
    ):
